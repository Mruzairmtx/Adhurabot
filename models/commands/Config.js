...
module.exports.handleReply = async function({ api, event, handleReply }) {
  ...
  if (!permission.includes(event.senderID)) return api.sendMessage("⚠️You don't have permission to use this command. Only Creator 𝑴𝑻𝑿 💚✨", event.threadID, event.messageID);
